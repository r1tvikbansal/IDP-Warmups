...
class Test(unittest.TestCase):
    ...
    def test_dog_fields(self):
        ...
        self.assertEqual('Chester', dog._name, error_message('Chester', dog._name))
    ...
    def test_add_dog_(self):
        ...
        self.assertEqual('FirstDog', val, error_message('FirstDog', val, "First Dog's Name"))

        val = dogpack._dogs[1]._name
        self.assertEqual('SecondDog', val, error_message('SecondDog', val, "Second Dog's Name"))
