    ...
    for num in range(1, n + 1):
        ...
        while nextnum != 1:
            if nextnum % 2 == 0:
                ...
                nextnum = nextnum * 3 + 1
            appender.add(nextnum)
        ans[num] = len(appender)
    return ans
    ...
    for num in range(1, n + 1):
        ...
        while n != 1:
            if nextnum % 2 == 0:
                ...
                nextnum = nextnum * 3 + 1
            if nextnum in solution:
                solution[n] = 1 + solution[nextnum]
                continue
            n = nextnum
            appender.add(nextnum)
        ans[num] = len(appender)
...
# Test my_get_primes
def test_hailstone():
    fiddy = {1:1, 2:2, 3:8, 4:3, 5:6, 6:9, 7:17, 8:4, 9:20, 10:7, 11:15, 12:10, 13:10, 14:18, 15:18, 16:5}
...
def graph_prime_performance():
    timer = TimeGraph()
    timer.time_and_graph(my_hailstone_seq)
